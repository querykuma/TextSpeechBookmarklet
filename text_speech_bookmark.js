javascript: (() => {/* eslint-disable-line no-unused-labels */
  /*
   * TextSpeechBookmarklet v1.04
   * (c) 2020 Query Kuma
   * Released under the MIT License.
   */
  /* cSpell:ignore meiryo,ratemenu,ratesetting,afterbegin,Bookmarklet,Kuma,Johnson,Jacob,Rideout,Maciej,Ceglowski,Holowaychuk */
